...
public class HeavySql extends BaseEntity<HeavySql> {
   ...
   public void accept(IVisitor visitor) {
      visitor.visitHeavySql(this);
   }

   public HeavySql addService(Service service) {
      m_services.put(service.getKey(), service);
      return this;
   }

   public HeavySql addUrl(Url url) {
   ...
   public boolean equals(Object obj) {
      if (obj instanceof HeavySql) {
         HeavySql _o = (HeavySql) obj;
   ...
   @Override
   public void mergeAttributes(HeavySql other) {
   }
