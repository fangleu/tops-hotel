...
public class DefaultJsonParser {
         ...
         if (parent instanceof DomainGroup) {
            if (ENTITY_DOMAINS.equals(tag)) {
               ...
               if (ENTITY_DOMAINS.equals(parentTag)) {
                  ...
                  m_linker.onDomain((DomainGroup) parent, domains);
                  m_objs.push(domains);
               } else {
   ...
   protected void onValue(String value) {
      ...
      if (parent instanceof DomainGroup) {
         parseForDomainGroup((DomainGroup) parent, tag, value);
      } else if (parent instanceof Domain) {
   ...
   public void parseForDomainGroup(DomainGroup domainGroup, String tag, String value) {
      if (ENTITY_DOMAINS.equals(tag)) {
         // do nothing here
      } else {
         throw new RuntimeException(String.format("Unknown tag(%s) of %s under %s!", tag, domainGroup, m_tags));
      }
   }
