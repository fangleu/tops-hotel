...
public interface IBaseDao<T, ID extends Serializable> {
     ...
     * @return 查询实体
     */
    public abstract T getBySQL(String sqlString, final Class<T> beanClass, Object... values);
     ...
     * @return 查询多个实体的List集合
     */
    public abstract List<T> getListBySQL(String sqlString, final Class<T> beanClass, Object... values);
     ...
     */
    public abstract PageResults<T> findPageByFetchedHql(String hql, final Class<T> beanClass, String countHql, int pageNo, int pageSize, Object... values);
