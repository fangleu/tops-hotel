...
<div style="display:none;position: absolute;z-index:100" class="newEndorseOrder" id="child_order">
    ...
    <div class="newReOrder">
        <div class="rawOrd clearfix">
            ...
            <em class="ordNum" style="float:left"><em>¥ </em>${(relatedOrderVos[0].externalObject.totalRoomFeeYuan)!}</em>
        </div>
        <ul class="orderSta">
                ...
                <div class="staList <#if !endorseOrder_has_next>currentSta</#if>">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="weight"><em>¥ </em>${(endorseOrder.externalObject.totalRoomFeeYuan)!}</td>
                        </tr>
                        <tr>
