...
<div class="hotel_resultInfo clearfix">
	...
	<input type="hidden" id="sortOrder" name="sortOrder" value=""/>
        ...
        <#if (searchParam.sortItem)?? && searchParam.sortItem=="1"><#if searchParam.sortOrder=="0">ascend<#elseif searchParam.sortOrder=="1">descend</#if></#if>" 
        sortItem="1" sortOrder="<#if (searchParam.sortItem)??><#if searchParam.sortItem=="1">${(searchParam.sortOrder)!}</#if></#if>">价格<i style="position:static;"></i>
        </span>
        <span id="startOrder" class="sorttab <#if (searchParam.sortItem)?? && searchParam.sortItem=="0"><#if searchParam.sortOrder=="0">ascend<#elseif searchParam.sortOrder=="1">descend</#if></#if>"
         sortItem="0" sortOrder="<#if (searchParam.sortItem)??><#if searchParam.sortItem=="0">${(searchParam.sortOrder)!}</#if></#if>">星级<i style="position:static;"></i>
        </span>
    </span>
